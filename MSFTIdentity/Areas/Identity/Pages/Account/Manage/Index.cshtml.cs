...
namespace MSFTIdentity.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(MSFTIdentityUser user)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                var userId = await _userManager.GetUserIdAsync(user);
                throw new InvalidOperationException($"Unexpected error occurred setting profile information for user with ID '{userId}'.");
            }
